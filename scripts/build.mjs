...
const BAIDU_TONGJI_SCRIPT = [
  ...
  "  hm.src = \"https://hm.baidu.com/hm.js?1e0e6340f21d079321ccb3c3ba8a8d3e\";",
...
function jsonLdForPage({ page, canonical, title, description, sites, allSites, built }) {
  const breadcrumb = page === 1
    ? [{ "@type": "ListItem", position: 1, name: "API 中转站评测与推荐", item: canonical }]
    : [{ "@type": "ListItem", position: 1, name: "API 中转站评测与推荐", item: `${ORIGIN}/` }, { "@type": "ListItem", position: 2, name: `第 ${page} 页`, item: canonical }];
  const graph = [
    { "@type": "WebSite", "@id": `${ORIGIN}/#website`, url: `${ORIGIN}/`, name: "API 中转站评测与推荐", inLanguage: "zh-CN" },
...
function renderPage({ page, totalPages, sites, allSites, built }) {
  ...
  const title = page === 1 ? "API 中转站评测与推荐" : `API 中转站评测与推荐第 ${page} 页｜第 ${first}–${last} 名`;
  const description = page === 1
    ? `API 中转站评测与推荐榜收录 ${allSites.length} 家 AI API 中转站的公开信息，提供 OpenAI、Claude、Gemini、Codex 等模型专题、在线率、延迟、选择指南与风险提示。`
    : `API 中转站评测与推荐榜第 ${page} 页，静态展示推荐顺序第 ${first}–${last} 名的 AI API 中转站公开在线率、延迟、模型和服务信息。`;
...
<html lang="zh-CN"><head>
  ...
  <meta name="keywords" content="API 中转站评测与推荐,API 中转站排名,中转站推荐,AI API 中转站,OpenAI 中转站,Claude 中转站,Gemini 中转站,Codex 中转站" />
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" />
  <meta name="author" content="API 中转站评测与推荐" />
  <meta name="theme-color" content="#ffffff" />
  <meta property="og:type" content="website" /><meta property="og:locale" content="zh_CN" /><meta property="og:site_name" content="API 中转站评测与推荐" />
  <meta property="og:title" content="${escapeHtml(title)}" /><meta property="og:description" content="${escapeHtml(description)}" /><meta property="og:url" content="${canonical}" /><meta property="og:image" content="${ORIGIN}/assets/og-image.png" /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="630" /><meta property="og:image:alt" content="API 中转站评测与推荐榜" />
  ...
  <header class="site-header"><div class="header-inner"><a class="brand" href="${root}/" aria-label="API 中转站评测与推荐首页"><span class="brand-mark">API</span><span>API 中转站评测与推荐</span></a><nav class="site-nav" aria-label="主要导航"><a href="${root}/#ranking">排行榜</a><a href="${root}/#topics">模型专题</a><a href="${root}/#guide">怎么选</a><a href="${root}/#faq">常见问题</a></nav></div></header>
  <main id="main">
    <nav class="breadcrumbs" aria-label="面包屑">${page === 1 ? '<span aria-current="page">API 中转站评测与推荐</span>' : `<a href="${root}/">API 中转站评测与推荐</a><span aria-hidden="true">/</span><span aria-current="page">第 ${page} 页</span>`}</nav>
    <section class="hero"><p class="eyebrow">AI API RELAY DIRECTORY · 2026</p><h1>${page === 1 ? 'API 中转站<span>评测与推荐</span>' : `API 中转站评测与推荐<br /><span>第 ${page} 页</span>`}</h1><p class="hero-copy">收录最多 400 家 AI API 中转站公开资料，按静态 HTML 分页展示。比较在线率、延迟、模型覆盖和服务信息，并通过模型专题与选择指南建立自己的测试标准。</p><ul class="hero-meta"><li>每天自动更新两次</li><li>本次更新 <time datetime="${built.iso}">${built.visible}</time></li><li>公开信息仅用于初筛</li></ul></section>
  ...
  <footer class="site-footer"><div class="footer-inner"><div><a class="brand" href="${root}/"><span class="brand-mark">API</span><span>API 中转站评测与推荐</span></a><p>公开资料用于初筛；先小额测试，后决定长期使用。</p></div><a href="#main">返回顶部 ↑</a></div></footer>
...
function renderTopicPage({ topic, matches, allSites, built }) {
  ...
  const title = `${topic.label}推荐｜API 中转站评测与推荐`;
  ...
  const jsonLd = JSON.stringify({ "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "BreadcrumbList", "@id": `${canonical}#breadcrumb`, itemListElement: [{ "@type": "ListItem", position: 1, name: "API 中转站评测与推荐", item: `${ORIGIN}/` }, { "@type": "ListItem", position: 2, name: topic.label, item: canonical }] },
